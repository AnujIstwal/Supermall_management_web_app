...
export default function Shops() {
  ...
  const sortField = "shopName"; // default sort by name
    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-y-2 px-6 py-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-3">
          ...
          <button
            type="button"
            className="flex cursor-pointer items-center justify-center gap-x-1 rounded-full border border-neutral-950 bg-neutral-100 px-4 py-1 text-black"
            onClick={() => {

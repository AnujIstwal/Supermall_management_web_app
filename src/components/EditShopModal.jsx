...
export default function EditShopModal({ isOpen, onClose, onSubmit, shop }) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-lg">
        <h2 className="mb-4 text-xl font-semibold">Edit Shop</h2>
        <form
          onSubmit={handleSubmit((data) => {
            onSubmit(shop.id, data);
            onClose();
          })}
          className="space-y-4"
        >
            ...
            <input
              ...
              {...register("floor", {
                ...
                pattern: {
                  ...
                  message: "Floor format must be like 1st, 2nd etc.",
                },
              })}
              className="w-full rounded border px-3 py-2"
            />
          ...
          <div>
            <input
              ...
              {...register("contact", {
                ...
                pattern: {
                  value: /^\+91\s?\d{10}$/,
                  message: "Contact must be a valid +91 number",
                },
              })}
              className="w-full rounded border px-3 py-2"
            />
